...
public class Constantes {
    ...
    public static final int   JUGADOR_VIDA_INICIAL = 120;
    ...
    public static final int   ENEMIGO_TANQUE_DANIO_DISPARO = 5; // Daño del proyectil 5 porque nunca falla
    
    // configuracion de oleadas
    public static final int OLEADAS_PARA_GANAR = 5;
    public static final int OLEADA_ENEMIGOS_BASE = 8;
